const CACHE='carpentry-quotes-v1';
const APP_SHELL=['/','/index.html','/stitch-hybrid.css','/stitch-hybrid.js','/manifest.webmanifest','/pwa-icon.svg','/vendor/html2pdf.bundle.min.js'];
